...
public class UserEntity : BaseEntity
{
	...
	[JsonIgnore] public virtual ICollection<UserPlanEntity> UserPlans { get; set; } = [];

	[JsonIgnore] public virtual ICollection<WordSessionEntity> WordSession { get; set; } = [];

	[JsonIgnore] public virtual ICollection<UserCheckInEntity> CheckIns { get; set; } = [];

	[JsonIgnore] public virtual ICollection<MistakeBookEntity> MistakeBook { get; set; } = [];
}
