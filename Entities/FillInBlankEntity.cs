...
public class FillInBlankWordEntity : BaseEntity
{
    ...
    [MaxLength(Constants.Question.MaxQuestionWordLength,
        ErrorMessage = ErrorMessages.ValidationError.OverMaxQuestionWordLength)]
...
public class FillInBlankEntity : BaseEntity
{
    ...
    [MaxLength(Constants.Question.MaxQuestionTransitionLength,
        ErrorMessage = ErrorMessages.ValidationError.OverMaxQuestionTransitionLength)]
