    ...
    : ControllerBase
{
    ...
    public async Task<IActionResult> PublishPublicAnnouncement(
        [FromBody] PublicAnnouncementPublish publicAnnouncementPublish)
    {
        ...
        if (await repository.PublicAnnouncementRepository.SaveAsync())
            return Ok(ResponseFactory.NewSuccessBaseResponse(SuccessMessages.Controller.PublicAnnouncement
                .PublishSuccess));
    ...
    public async Task<IActionResult> DeletePublicAnnouncement(Guid publicAnnouncementId)
    {
        ...
        if (await repository.PublicAnnouncementRepository.SaveAsync())
            return Ok(ResponseFactory.NewSuccessBaseResponse(
                SuccessMessages.Controller.PublicAnnouncement.DeleteSuccess));
