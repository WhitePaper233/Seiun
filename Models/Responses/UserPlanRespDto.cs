...
{
	public static CurrentWordBookResp Success(CurrentPlanData currentWordBook) => new(StatusCodes.Status200OK,
	SuccessMessages.Controller.UserPlan.GetCurrentPlanSuccess,
	currentWordBook);

	public static CurrentWordBookResp Fail(int code, string message) => new(code, message, null);
}
