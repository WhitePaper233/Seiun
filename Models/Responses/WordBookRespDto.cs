...
{
	public static WordBookListResp Success(List<WordBook> wordBooks) => new(StatusCodes.Status200OK,
	SuccessMessages.Controller.WordBook.GetWordBooksSuccess,
	new WordBookListData
	{
		WordBooks = wordBooks
	});

	public static WordBookListResp Fail(int code, string message) => new(code, message, null);
}
