...
{
	public static MistakeListResp Success(List<Guid>? mistakeList) => new(StatusCodes.Status200OK,
	...
	public static MistakeListResp Fail(int code, string message) => new(code, message, null);
}
...
{
	public static MistakeDetailResp Success(WordEntity mistakeWord) => new(StatusCodes.Status200OK,
	...
	public static MistakeDetailResp Fail(int code, string message) => new(code, message, null);
}
	...
	: BaseRespWithData<List<MistakeDetail>>(code, message, mistakeWordDetails)
{
	...
	public static MistakesResp Fail(int code, string message) => new(code, message, null);
}
